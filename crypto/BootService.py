...
class BootService:
    ...
    def run(self):
        ...
        print("----- Etapte 1: création des fichiers key1/key2 pour les clés usb -----")
        # 1. hasher mdp-cle1
        ...
        print("----- Etapte 2: création du fichier vide unlockedFile dans ramdisk/ -----")

        # Création unlockedFile vide
        self.fileHandler("./ramdisk/unlockedFile", "w", "")

        print("----- Etapte 3: création du fichier dataFile.decrypt dans ramdisk/ -----")
        ...
        print("----- Etapte 4: création du fichier dataFile dans ramdisk/ -----")
